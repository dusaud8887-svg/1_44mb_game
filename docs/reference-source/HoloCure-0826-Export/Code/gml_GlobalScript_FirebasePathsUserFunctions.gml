...
function Firebase_Path_Join_Pair(arg0, arg1)
{
...
function Firebase_Path_GetName(arg0, arg1)
{
    var list = Firebase_Path_ToList(arg0);
    var name = ds_list_find_value(list, ds_list_size(list) - 1 - arg1);
    ds_list_destroy(list);
    return name;
}

function Firebase_Path_ToList(arg0)
{
...
function Firebase_Path_Compare(arg0, arg1)
{
    var list0 = Firebase_Path_ToList(arg0);
    var list1 = Firebase_Path_ToList(arg1);
...
function Firebase_Path_Back(arg0, arg1)
{
    var str = "";
    var list = Firebase_Path_ToList(arg0);
