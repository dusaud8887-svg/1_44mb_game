if (stickerData != -1)
{
    ...
    if (!isInView)
    {
        ...
        draw_sprite_ext(spr_stamppointer, 0, _view_center_x + _x2, _view_center_y + _y2, 1, 1, arrowDir, c_white, 1);
    }
    else
    {
        draw_sprite_ext(spr_stamppointer, 0, x, y - 40, 1, 1, 270, c_white, 1);
    }
    draw_set_alpha(1);
