function __input_steam_handles_changed()
{
    ...
    var _steam_handles = extension_stubfunc_real();
    ...
    repeat (array_length(_global.__gamepads))
    {
        ...
        if (is_struct(_gamepad) && _gamepad.__steam_handle != undefined && _gamepad.__steam_handle_index != extension_stubfunc_real(_gamepad.__steam_handle))
        {
            return true;
        }
        _i++;
