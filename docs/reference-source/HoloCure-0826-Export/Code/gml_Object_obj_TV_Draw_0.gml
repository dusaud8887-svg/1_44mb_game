...
if (inView)
{
    ...
    depth = -y;
    draw_sprite_ext(sprite_index, image_index, x + ((hitShake > 0) * shakeDisplacement), y - 4, 1, -0.7, 0, c_black, 0.4);
    ...
    if (timeStartedAttacking > -1 && global.debug)
    {
        ...
        draw_text_scribble(x, y + 5, totalDamageTaken / max(1, timeStartedAttacking div 60));
    }
}
