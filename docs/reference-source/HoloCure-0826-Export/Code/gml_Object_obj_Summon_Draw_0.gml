...
if (!isInView)
{
    ...
    draw_sprite_ext(spr_summonPointer, 0, _view_center_x + _x2, _view_center_y + _y2, 1, 1, arrowDir, c_white, 1);
    draw_sprite_ext(sprite_index, image_index, _view_center_x + _x2, _view_center_y + _y2 + 5, image_xscale, image_yscale, 0, c_white, 1);
}
