function glr_enable_directional(arg0)
{
    if (arg0 && !global.GLR_DIRECTIONAL_ENABLED && !surface_exists(global.GLR_DIRECTIONAL_SURFACE))
    {
    ...
    global.GLR_DIRECTIONAL_ENABLED = arg0;
}
