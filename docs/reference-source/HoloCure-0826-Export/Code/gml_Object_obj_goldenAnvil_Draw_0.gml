...
if (!isInView)
{
    ...
    draw_sprite_ext(spr_goldanvilpointer, 0, _view_center_x + _x2, _view_center_y + _y2, 1, 1, arrowDir, c_white, 1);
}
else
{
    draw_sprite_ext(spr_goldanvilpointer, 0, x, y - 90, 1, 1, 270, c_white, 1);
}
gpu_set_blendmode(bm_add);
draw_sprite_ext(spr_ItemLight, 0, x, y, 1, 1, 0, c_white, 0.9);
gpu_set_blendmode(bm_normal);
draw_sprite(spr_GoldenAnvil, 0, x, y);
