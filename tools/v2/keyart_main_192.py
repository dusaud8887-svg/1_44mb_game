...
# 반개한 모에 원반 눈 (경청 — 완전 대칭, 밝은 자홍 + 하이라이트)
noa_eye = [
    "22222",
    "22222",
    "ccccc",
...
g.blit(NX + 6, NY + 11, noa_eye)
g.blit(NX + 13, NY + 11, noa_eye)                          # 완전 동일 — 그것이 노아다
# 볼터치 (대칭 자홍)
g.run(NX + 5, NX + 6, NY + 18, "c"); g.run(NX + 17, NX + 18, NY + 18, "c")
# 정돈된 미소 (양쪽 입꼬리 동일)
...
for x0, x1, y in fr:
    g.run(x0, x1, y, "8")
# 프린지 갈래 끝 — 이마 중간까지만 (눈 위 스킨 2~3줄 확보)
for x0, x1, y in [(59, 62, 32), (65, 67, 31), (70, 72, 30), (75, 77, 29), (80, 81, 28)]:
    g.run(x0, x1, y, "8")
for y in range(26, 31):
    g.run(84, 86, y, "7")                                  # 우측 그림자 머리
# 눈 — 모에 원반 홍채 (근안이 1px 큼), 눈썹은 프린지 아래 생략
g.blit(64, 33, [
    ".22222.",
    "2222222",
    "2788872",
...
# 볼터치 + 벌린 방송 미소 (1px 오프셋)
g.run(63, 65, 41, "6"); g.run(79, 81, 41, "6")
g.blit(68, 42, [
    "2222222",
    "2bbbbb2",
    ".2bbb2.",
...
g.set(75, 41, "2")                                         # 오른쪽 입꼬리 상승
g.run(69, 72, 43, "5")                                     # 윗니 하이라이트
# 헤드셋 (한쪽 수신기)
g.blit(83, 33, [
    ".22",
    "222",
