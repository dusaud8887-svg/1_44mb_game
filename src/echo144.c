...
/* echo_16_a  16x16  2bpp MSB-first, 64 bytes */
static const uint8_t PX_ECHO_16_A[64] = {
    0x00,0xAA,0xA0,0xC0,
    0x02,0xAA,0xAB,0x0C,
    0x0A,0xAA,0xAB,0x0C,
    0x0A,0xFE,0xF8,0xF0,
...
/* echo_16_b  16x16  2bpp MSB-first, 64 bytes */
static const uint8_t PX_ECHO_16_B[64] = {
    0x00,0xAA,0xA0,0x00,
    0x02,0xAA,0xA8,0xC0,
    0x0A,0xAA,0xAB,0x0C,
    0x0A,0xFE,0xFB,0x0C,
...
/* echo_16_hit  16x16  2bpp MSB-first, 64 bytes */
static const uint8_t PX_ECHO_16_HIT[64] = {
    0x00,0xAA,0xA0,0xC0,
    0x02,0xAA,0xAB,0x0C,
    0x0A,0xAA,0xAB,0x0C,
    0x0A,0xFE,0xF8,0xF0,
...
/* echo_16_live  16x16  2bpp MSB-first, 64 bytes */
static const uint8_t PX_ECHO_16_LIVE[64] = {
    0x00,0xAA,0xA0,0xC0,
    0x02,0xAA,0xAB,0x0C,
    0x0A,0xAA,0xAB,0x0C,
    0x0A,0xFE,0xF8,0xF0,
...
/* seek_16_a  16x16  2bpp MSB-first, 64 bytes */
static const uint8_t PX_SEEK_16_A[64] = {
    0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,
...
/* seek_16_hit  16x16  2bpp MSB-first, 64 bytes */
static const uint8_t PX_SEEK_16_HIT[64] = {
    0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,
...
/* format_16_a  16x16  2bpp MSB-first, 64 bytes */
static const uint8_t PX_FORMAT_16_A[64] = {
    0x00,0x15,0x40,0x00,
    0x00,0x7D,0x50,0x00,
    0x01,0xFF,0xF4,0x00,
    0x01,0xEF,0xB4,0x00,
...
/* format_16_b  16x16  2bpp MSB-first, 64 bytes */
static const uint8_t PX_FORMAT_16_B[64] = {
    0x00,0x15,0x40,0x00,
    0x00,0x7D,0x50,0x00,
    0x01,0xFF,0xF4,0x00,
    0x01,0xEF,0xB4,0x00,
...
/* portrait_echo_48  48x48  2bpp MSB-first, 576 bytes */
static const uint8_t PX_PORTRAIT_ECHO_48[576] = {
    ,
};
/* portrait_seek_48  48x48  2bpp MSB-first, 576 bytes */
static const uint8_t PX_PORTRAIT_SEEK_48[576] = {
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    ...
    ,
};
/* portrait_format_48  48x48  2bpp MSB-first, 576 bytes */
static const uint8_t PX_PORTRAIT_FORMAT_48[576] = {
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    ...
    ,
...
/* ---- 카드 아이콘 16종 (12x12 2bpp, CardId 순). 색은 카드 상태색을 런타임 적용 ---- */
/* card_modem_2400  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_MODEM_2400[36] = {
    0x00,0x00,0x00,
    0x00,0x00,0x50,
    0x00,0x00,0x50,
    0x00,0x00,0x50,
...
/* card_modem_14k  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_MODEM_14K[36] = {
    0x00,0x00,0x00,
    0x00,0x00,0x50,
    0x00,0x00,0x50,
    0x00,0x00,0x50,
...
/* card_modem_56k  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_MODEM_56K[36] = {
    0x00,0x00,0xC0,
    0x00,0x00,0xA0,
    0x00,0x00,0xA0,
    0x00,0x00,0xA0,
...
/* card_chat  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_CHAT[36] = {
    0x00,0x00,0x00,
    0x0A,0xAA,0x00,
    0x2A,0xAA,0x80,
    0x20,0x00,0x80,
...
/* card_voice  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_VOICE[36] = {
    0x00,0x00,0x00,
    0x00,0x80,0x00,
    0x08,0x88,0x00,
    0x08,0x88,0x80,
...
/* card_clip  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_CLIP[36] = {
    0x00,0x00,0x00,
    0x2A,0xAA,0x80,
    0x25,0x55,0x80,
    0x23,0x00,0x80,
...
/* card_bad  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_BAD[36] = {
    0x20,0x00,0x08,
    0x28,0x00,0x28,
    0x0A,0x00,0xA0,
    0x02,0x82,0x80,
...
/* card_patch  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_PATCH[36] = {
    0x00,0x00,0x00,
    0x00,0x00,0xA8,
    0x00,0x02,0xA8,
    0x00,0x02,0x88,
...
/* card_multi  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_MULTI[36] = {
    0x00,0x00,0x00,
    0x0A,0xAA,0x00,
    0x08,0x02,0x00,
    0x08,0xAA,0xA0,
...
/* card_cache  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_CACHE[36] = {
    0x00,0x00,0x00,
    0x0A,0xAA,0xA0,
    0x08,0x00,0x20,
    0x0A,0xAA,0xA0,
...
/* card_macro  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_MACRO[36] = {
    0x00,0x00,0x00,
    0x02,0xAA,0x00,
    0x0A,0x02,0x80,
    0x28,0x00,0x80,
...
/* card_firewall  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_FIREWALL[36] = {
    0x00,0x00,0x00,
    0x02,0xAA,0x80,
    0x0A,0xAA,0xA0,
    0x08,0xC3,0x20,
...
/* card_prefetch  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_PREFETCH[36] = {
    0x00,0x00,0x00,
    0x08,0x02,0x00,
    0x0A,0x02,0x80,
    0x0A,0x82,0xA0,
...
/* card_surge  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_SURGE[36] = {
    0x00,0x00,0x00,
    0x00,0x0A,0x00,
    0x00,0x28,0x00,
    0x00,0xA8,0x00,
...
/* card_marker  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_MARKER[36] = {
    0x00,0x00,0x00,
    0x00,0x28,0x00,
    0x00,0x28,0x00,
    0x02,0x28,0x80,
...
/* card_defrag  12x12  2bpp MSB-first, 36 bytes */
static const uint8_t PX_CARD_DEFRAG[36] = {
    0x00,0x00,0x00,
    0x2A,0x28,0xA0,
    0x2A,0x28,0xA0,
    0x2A,0x28,0xA0,
...
static const uint8_t *const CARD_ICON[CARD_COUNT] = {
    PX_CARD_MODEM_2400, PX_CARD_MODEM_14K, PX_CARD_MODEM_56K, PX_CARD_CHAT,
    PX_CARD_VOICE, PX_CARD_CLIP, PX_CARD_BAD, PX_CARD_PATCH,
    PX_CARD_MULTI, PX_CARD_CACHE, PX_CARD_MACRO, PX_CARD_FIREWALL,
    PX_CARD_PREFETCH, PX_CARD_SURGE, PX_CARD_MARKER, PX_CARD_DEFRAG,
};
...
static void card_box(int x,int y,CardId id,bool active,bool live_preview) {
    ...
    uint32_t ipal[4]={0,0x001a1626,edge,COL_WHITE};       /* 아이콘 강조색=카드 상태색 */
    draw_sprite_2bpp(x+11,y+13,CARD_ICON[id],12,ipal,1);
    text_at(x+20,y+2,edge,CARD[id].short_name);
    if(CARD[id].buy)number_text(x+20,y+15,COL_AMBER,L"B%d",CARD[id].buy);
    if(is_fragment(id))number_text(x+20,y+15,g.live||live_preview?COL_MAGENTA:COL_DIM,L"S%d",CARD[id].signal);
}

static void draw_echo(int x,int y,int scale) {
    /* 대기 A/B는 링이 반 박자 늦게 따라오는 2px 차이 (40 §1 모션 문법) */
    const uint8_t *f=PX_ECHO_16_A;
    if(g.mode==PLAY&&g.invuln_ticks)f=PX_ECHO_16_HIT;
    else if(g.mode==PLAY&&g.live)f=PX_ECHO_16_LIVE;
    else if((((g.live?g.live_ticks:g.dead_ticks)>>4)&1))f=PX_ECHO_16_B;
    draw_sprite_2bpp(x,y,f,16,PAL_ECHO,scale);
    rect(x-3*scale,y+1*scale,scale,scale,COL_RED); /* 빨간 LIVE 핀 오버레이 (41 §3) */
}

static void draw_seek(int x,int y,int scale) {
    /* SEEK 사용 순간(붙잡기) = 가로 1px 눌림 + 케이블 반대 휨 */
    draw_sprite_2bpp(x,y,g.seek_fx_ticks?PX_SEEK_16_HIT:PX_SEEK_16_A,16,PAL_SEEK,scale);
}

static void draw_format(int x,int y,int scale) {
    /* 전환 중에는 베일 진행 막대가 A/B로 맥동한다 */
    const uint8_t *f=(g.transition_ticks&&((g.transition_ticks>>3)&1))?PX_FORMAT_16_B:PX_FORMAT_16_A;
    draw_sprite_2bpp(x,y,f,16,PAL_FORMAT,scale);
}
...
static void draw_title(void) {
    ...
    draw_sprite_2bpp(86,112,PX_PORTRAIT_ECHO_48,48,PAL_ECHO,1);rect(78,132,2,2,COL_RED);
    draw_sprite_2bpp(235,112,PX_PORTRAIT_FORMAT_48,48,PAL_FORMAT,1);
    line(112,112,209,112,COL_DIM);draw_seek(160,106,1); /* 시청자 1 - 회선 위에서 지켜본다 */
...
static void draw_channel(void) {
    ...
    int row=0;for(int i=0;i<8;++i)if(g.kingdom_mask&(1u<<i)){
        ...
        uint32_t ip[4]={0,0x001a1626,COL_CYAN,COL_WHITE};
        frame(x,y,137,22,COL_CYAN);draw_sprite_2bpp(x+11,y+11,CARD_ICON[id],12,ip,1);
        text_at(x+21,y+4,COL_WHITE,CARD[id].name);number_text(x+107,y+4,COL_AMBER,L"%dB",CARD[id].cost);++row;
    }
...
static void draw_play(void) {
    ...
    if(g.transition_ticks){rect(55,67,210,58,COL_BLACK);frame(55,67,210,58,COL_MAGENTA);draw_sprite_2bpp(77,96,PX_PORTRAIT_FORMAT_48,48,PAL_FORMAT,1);text_at(102,77,COL_WHITE,L"포맷 제로");text_at(102,94,COL_MAGENTA,L"UNSUPPORTED TIMESTAMP");text_at(102,110,COL_DIM,L"지원되지 않는 시간입니다.");}
...
static void draw_shop(void) {
    ...
    for(int i=0;i<10;++i){CardId id=shop_card(i);int x=12+(i%2)*154,y=88+(i/2)*24;uint32_t c=can_buy(id)?COL_WHITE:COL_DIM;
        ...
        uint32_t ac=!can_buy(id)?COL_DIM:is_fragment(id)?COL_MAGENTA:id==C_BAD?COL_RED:COL_CYAN;
        uint32_t ip[4]={0,0x001a1626,ac,COL_WHITE};draw_sprite_2bpp(x+7,y+7,CARD_ICON[id],12,ip,1);
        text_at(x+15,y,c,CARD[id].name);number_text(x+118,y,c,L"%dB",CARD[id].cost);
    }
